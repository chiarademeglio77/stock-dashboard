...
export const MOCK_ETFS: ETF[] = [
    ...
    { id: "STLAM.MI", name: "Stellantis", description: "Global automotive group (Fiat, Peugeot, Chrysler).", price: 23.15, previousPrice: 22.90, changePercent: 1.09, ytdChange: 3.19, startOfYearPrice: 22.43, sector: "Consumer Cyclical", region: "Italy" },
    { id: "STM.MI", name: "STMicroelectronics", description: "Global semiconductor leader.", price: 42.15, previousPrice: 41.50, changePercent: 1.57, ytdChange: 22.7, startOfYearPrice: 34.35, sector: "Technology", region: "Italy" },
    { id: "TIT.MI", name: "Telecom Italia", description: "Main telecommunications group in Italy.", price: 0.28, previousPrice: 0.275, changePercent: 1.82, ytdChange: 8.8, startOfYearPrice: 0.257, sector: "Communication Services", region: "Italy" },
    ...
    { id: "UCG.MI", name: "UniCredit", description: "Major European commercial bank.", price: 34.12, previousPrice: 33.50, changePercent: 1.85, ytdChange: 15.27, startOfYearPrice: 29.61, sector: "Financials", region: "Italy" },
